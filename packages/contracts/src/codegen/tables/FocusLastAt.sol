...
// Hex below is the result of `WorldResourceIdLib.encode({ namespace: "", name: "FocusLastAt", typeId: RESOURCE_TABLE });`
ResourceId constant _tableId = ResourceId.wrap(0x74620000000000000000000000000000466f6375734c61737441740000000000);
ResourceId constant FocusLastAtTableId = _tableId;

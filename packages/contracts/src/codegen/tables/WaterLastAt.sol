...
// Hex below is the result of `WorldResourceIdLib.encode({ namespace: "", name: "WaterLastAt", typeId: RESOURCE_TABLE });`
ResourceId constant _tableId = ResourceId.wrap(0x7462000000000000000000000000000057617465724c61737441740000000000);
ResourceId constant WaterLastAtTableId = _tableId;

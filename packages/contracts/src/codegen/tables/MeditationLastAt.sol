...
// Hex below is the result of `WorldResourceIdLib.encode({ namespace: "", name: "MeditationLastAt", typeId: RESOURCE_TABLE });`
ResourceId constant _tableId = ResourceId.wrap(0x746200000000000000000000000000004d656469746174696f6e4c6173744174);
ResourceId constant MeditationLastAtTableId = _tableId;

FieldLayout constant _fieldLayout = FieldLayout.wrap(
  0x0020010020000000000000000000000000000000000000000000000000000000
);

library MeditationLastAt {
  /**
